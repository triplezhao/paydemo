...
public class TestMainActivity extends Activity {
    String TAG = "cn.swiftpass.wftpay.wxapi.TestMainActivity";
...
//    }
    ...
    private class GetPrepayIdTask extends AsyncTask<Void, Void, Map<String, String>> {
        ...
        protected void onPreExecute() {
            dialog = ProgressDialog.show(TestMainActivity.this, getString(R.string.app_tip), getString(R.string.getting_prepayid));
        }
        ...
        protected void onPostExecute(Map<String, String> result) {
            ...
            if (result == null) {
                Toast
                        .makeText(TestMainActivity.this, getString(R.string.get_prepayid_fail), Toast.LENGTH_LONG)
                        .show();
            } else {
                if (result
                        .get("status")
                        .equalsIgnoreCase("0")) // 成功
                {

                    Toast
                            .makeText(TestMainActivity.this, R.string.get_prepayid_succ, Toast.LENGTH_LONG)
                            .show();
                    ...
                    if (typetag) {
                        ...
                        msg.setAppId(appId
                                .getText()
                                .toString());//wxd3a1cdf74d0c41b3
                        PayPlugin.unifiedAppPay(TestMainActivity.this, msg);
                    } else {
                        //支付宝
                        msg.setTradeType(MainApplication.PAY_NEW_ZFB_WAP);
                        PayPlugin.unifiedH5Pay(TestMainActivity.this, msg);
                    }
                } else {
                    Toast
                            .makeText(TestMainActivity.this, getString(R.string.get_prepayid_fail), Toast.LENGTH_LONG)
...
//        String out_trade_no = genOutTradNo();
        ...
        params.put("limit_credit_pay", credit_pay
                .getText()
                .toString()); // 是否禁用信用卡支付， 0：不禁用（默认），1：禁用
        String sign = createSign(signKey
                .getText()
                .toString(), params); // 9d101c97133837e13dde2d32a5054abb 威富通密钥
