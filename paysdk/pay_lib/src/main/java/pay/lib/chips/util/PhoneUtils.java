...
//	    if (isApplicationInBackground(context)) {
            /*ComponentName comp = new ComponentName(PayHelper.context.getPackageName(),
                PayHelper.context.getPackageName() + ".GuideActivity");
...
//		    ComponentName comp = new ComponentName(PayHelper.context.getPackageName(),
//				    PayHelper.context.getPackageName() + ".MainActivityNew");
//		    Intent intent = new Intent().setComponent(comp);
...
//        strUID = Settings.Secure.getString(context.getContentResolver(), Settings.Secure.ANDROID_ID);
    ...
    public static boolean isMainProcess(Context context) {
        ...
        for (ActivityManager.RunningAppProcessInfo appProcess : mActivityManager.getRunningAppProcesses()) {
            if (pid == appProcess.pid) {
                L.i(TAG, "PayHelper" + "onCreate(),pid=" + pid + ",processName=" + appProcess.processName + ",PackageName=" + context.getPackageName());
    ...
    public static String getIMEI(Context context) {
        String IMEI = SPUtils.read(context, SPUtils.SP_COM_CYOU_ACTIVATE_CODE_UID, SPUtils.PREF_KEY_ACTIVATE_CODE_UID, "");
