...
//                .handler(new Handler())// default*/
    ...
    public  static  ImageLoaderConfiguration getDefConfig(Context context){
        ...
        ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(context)
                .memoryCacheExtraOptions(PayHelper.screenWidth, PayHelper.screenHight) // default = device screen dimensions
//                .diskCacheExtraOptions(PayHelper.screenWidth*10, PayHelper.screenHight * 10, null)//设置了超过屏幕，不起作用，最大就到屏幕宽高，不设置，就会是原图。
